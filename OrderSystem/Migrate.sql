-- -====================================
-- Flyway Dry Run (2023-01-17 08:29:26)
-- -====================================

USE [OrderSystem_FWD_Shadow]
GO
SET ANSI_NULLS ON
GO
USE [OrderSystem_FWD_Shadow]
...
-- ---------------------------------------------------------------------------------------
CREATE TABLE [OrderSystem_FWD_Shadow].[dbo].[flyway_schema_history] (
...
ALTER TABLE [OrderSystem_FWD_Shadow].[dbo].[flyway_schema_history] ADD CONSTRAINT [flyway_schema_history_pk] PRIMARY KEY ([installed_rank]);
CREATE INDEX [flyway_schema_history_s_idx] ON [OrderSystem_FWD_Shadow].[dbo].[flyway_schema_history] ([success]);
GO
...
-- Executing: migrate -> v006.01.03.20221221161950 (with callbacks)
-- ---------------------------------------------------------------------------------------

-- Source: migrations\B006_01_03_20221221161950__Re-Baseline.sql
-- --------------------------------------------------------------
...
GO
PRINT N'Creating [dbo].[OrderIssue2]'
GO
CREATE TABLE [dbo].[OrderIssue2]
(
[ID] [int] NOT NULL,
[orderID] [int] NULL
)
...
-- Source: migrations\afterEachMigrate__MonitorVersionLog.sql
-- -----------------------------------------------------------
-- ---------------------------------------------------------------------
...
END
GO
INSERT INTO [OrderSystem_FWD_Shadow].[dbo].[flyway_schema_history] ([installed_rank], [version], [description], [type], [script], [checksum], [installed_by], [execution_time], [success]) VALUES (1, '006.01.03.20221221161950', 'Re-Baseline', 'SQL_BASELINE', 'B006_01_03_20221221161950__Re-Baseline.sql', 994958224, 'RED-GATE\andrew.pierce', 17, 1)
GO
USE [OrderSystem_FWD_Shadow]
GO
SET ANSI_NULLS ON
...
-- Executing: migrate -> v006.01.04 (with callbacks)
-- ---------------------------------------------------------------------------------------

-- Source: migrations\V006_01_04__AddCol.sql
-- ------------------------------------------
ALTER TABLE [dbo].[Customer] ADD
[RG_ID2] [nvarchar] (30) NULL
GO
...
END
GO
INSERT INTO [OrderSystem_FWD_Shadow].[dbo].[flyway_schema_history] ([installed_rank], [version], [description], [type], [script], [checksum], [installed_by], [execution_time], [success]) VALUES (2, '006.01.04', 'AddCol', 'SQL', 'V006_01_04__AddCol.sql', -570417140, 'RED-GATE\andrew.pierce', 4, 1)
GO
USE [OrderSystem_FWD_Shadow]
GO
SET ANSI_NULLS ON
...
-- Source: migrations\afterMigrate__MonitorReleaseLog.sql
-- -------------------------------------------------------
-- ---------------------------------------------------------------------
-- Annotate this release on Redgate SQL Monitor 
-- ---------------------------------------------------------------------
